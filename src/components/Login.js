...
import one from '../assets/login.jpg';
...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      setError('Enter valid username and password'); // Set local error message
  ...
  return (
    <div className={`fixed inset-0 z-50 overflow-y-auto bg-black bg-opacity-95 flex items-center justify-center ${isVisible ? '' : 'hidden'}`}>
      <motion.div
        className="bg-white rounded-lg shadow-lg overflow-hidden w-full mt-10 mb-10 mx-10 max-w-[900px] relative"
        initial="hidden"
        animate="visible"
        exit="exit"
      ...
      >
        <motion.button
          className="absolute top-4 right-4 bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-1 px-2 rounded-full focus:outline-none z-50"
          onClick={handleClose}
        ...
        <div className="flex flex-col lg:flex-row-reverse">
          ...
          <div className="w-full lg:w-1/2 p-8 flex flex-col justify-center">
            <h2 className="text-xl lg:text-2xl xl:text-4xl font-bold mb-6 text-center text-gray-800">Welcome Back!</h2>
            ...
            <form className="flex flex-col gap-3">
              ...
              <p className="text-center text-gray-800">
                ...
                <span onClick={handleRegister} className="text-orange-500 hover:text-orange-700 cursor-pointer">
                  Register
                </span>
              </p>
            </form>
